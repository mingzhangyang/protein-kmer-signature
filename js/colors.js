...
const colorGradient3 = new ColorGradient(Color.fromHex('#33ccff'), Color.fromHex('#ff0066'), [0, 100]);
const colorGradient4 = new ColorGradient(Color.fromHex('#33ccff'), Color.fromHex('#ff0066'), [0, 40]);
