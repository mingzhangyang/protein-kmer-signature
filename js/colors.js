...
const colorGradient3 = new ColorGradient(Color.fromHex('#aaccff'), Color.fromHex('#ff0066'), [0, 40]);
const colorGradient4 = new ColorGradient(Color.fromHex('#aaccff'), Color.fromHex('#ff0066'), [0, 10]);
